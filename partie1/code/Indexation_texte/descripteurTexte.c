...
void copieTexteTok(void)//Mettre en paramettre d'entré le nom du fichier choisit
{
    ...
    texteTok = fopen("../../../../partie1/code/Indexation_texte/Nettoyer/fichier.tok", "r");

    // ouvrir le fichier en écriture
    copie = fopen("../../../../partie1/code/Indexation_texte/Nettoyer/copieTexteSansStopword.tok", "w");
...
void comptage(char* NomFichier) //Mettre en paramettre d'entré le nom du fichier choisit
{
    ...
    mot = fopen("../../../../partie1/code/Indexation_texte/Nettoyer/fichier.tok", "r");
    texteTokCopie = fopen("../../../../partie1/code/Indexation_texte/Nettoyer/copieTexteSansStopword.tok", "r");

    // ouvrir le fichier en écriture
    char *emplacement=(char *)malloc(strlen("../../../../partie1/Base_descripteurs/Base_descripteurs_textes/")+strlen("_descripteur.txt")+strlen(NomFichier)+1);
    strcpy(emplacement,"../../../../partie1/Base_descripteurs/Base_descripteurs_textes/");
   ...
   while ( !feof(mot)) //lecture jusqu'à la fin du fichier
   {
    ...
    while(sup || sup2)
    {
       sup = remove("../../../../partie1/code/Indexation_texte/Nettoyer/copieTexteSansStopword.tok");
       sup2 = remove ("../../../../partie1/code/Indexation_texte/Nettoyer/fichier.tok");
    }
...
void miseAJourListeDescripteurstextes(char* nomFichierParam){
	...
	listeDescripteurs=fopen("../../../../partie1/Liste_descripteurs/Liste_descripteurs_textes.txt","a");

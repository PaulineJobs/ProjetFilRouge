...
{	
    ...
    char *emplacement;
    emplacement =(char*)malloc(strlen("../../Corpus/TEXTE/")+strlen(NomTexteXML)+1);
  
    strcpy(emplacement,"../../Corpus/TEXTE/");
...
void majMin()
{
    ...
    // ouvrir le fichier en écriture
    min = fopen("../Indexation_texte/Nettoyer/plusDeMaj.clean", "w");
...
void suppressionBalise(){
    ...
    // ouvrir le fichier en lecture
    init = fopen("../Indexation_texte/Nettoyer/plusDeMaj.clean", "r");

    // ouvrir le fichier en écriture
    clean = fopen("../Indexation_texte/Nettoyer/plusDeBalise.clean", "w");
...
void espaceApostrophe(){
    ...
    // ouvrir le fichier en écriture
    apostrophe = fopen("../Indexation_texte/Nettoyer/apostrophe.clean", "w");
...
void retirePonctuation(){
    ...
    // ouvrir le fichier en écriture
    ponctuation = fopen("../Indexation_texte/Nettoyer/fichier.clean", "w");
